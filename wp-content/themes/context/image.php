...
<?php get_header(); ?>
	...
	<!-- Content
	============================================= -->
	<section id="main-content" style="padding: 30px; background: papayawhip;">
		...
		<div class="row">
			...
			<!-- Post Content
			============================================= -->
			<main class="post-content col-xs-8" style="background: sliver; color: white; padding: 30px; font-size: 16px;">
